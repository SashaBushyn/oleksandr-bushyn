...
public interface RoomRepository extends JpaRepository<Room, Long> {
    ...
    Page<RoomDto> getFreeRoomsOnDates(@Param("dateIn") LocalDate dateIn, @Param("dateOut") LocalDate dateOut, Pageable pageable);
    ...
    List<RoomDto> getFreeRoomsForOrder(@Param("id") Long id);
}
